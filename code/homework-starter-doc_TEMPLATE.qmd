...
drought_exp_clean <- drought_exp %>% 
  ...
  mutate(
    species_name = factor(species_name, levels = c(
      "Encelia californica",
    ...
    water_treatment = factor(water_treatment, levels = c( "Drought stressed","Well watered")))
...
# density curves describes distribution of each variable
# on the bottom left have 10 different geom point syle plot for representing relationships between variable
